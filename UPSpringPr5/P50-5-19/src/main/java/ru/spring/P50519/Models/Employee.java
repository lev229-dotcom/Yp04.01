...
public class Employee {
    ...
    inverseJoinColumns=@JoinColumn(name = "hobbi_id"))
    ...
    public List<Hobbi> getHobbies() {
        return hobbies;
    }

    public void setHobbies(List<Hobbi> hobbies) {
    ...
    public Employee(Long id, String name, String surname, String patronymic, int age, int amount_of_kids, String nationality, Dolj dolj, Account account, List<Hobbi> hobbies) {
        this.id = id;
        this.name = name;
